# Generated by Powerlevel10k configuration wizard on 2025-01-17 at 18:25 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local    commits='%4F'  # blue foreground
      local    stashed='%7F'  # gray foreground
      local   modified='%3F'  # yellow foreground
      local  untracked='%7F'  # gray foreground
      local conflicted='%1F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%f'  # default foreground
      local      clean='%f'  # default foreground
      local    commits='%f'  # default foreground
      local    stashed='%f'  # default foreground
  ...
  # typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION=''
  # typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION=''
  # typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION='󱚿'
